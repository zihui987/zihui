...
Provides xiax 夏/xia 仁/xia 审 with direct read/write access to the Obsidian
vault at D:/AI-哈比星球/知识库 (external read-only ref, classified index — see B2 classification).
Works without Obsidian running -- reads Markdown files directly from the
filesystem.

Phase 1 migration (2026-06-18): Changed VAULT_PATH from E:/哈比星球 to
D:/AI-哈比星球/知识库 (external read-only ref, classified index — pending B3 selective migration).
...
# -- Vault path ------------------------------------------------------------
# 2026-06-19: Pointing to D:/AI-哈比星球/知识库 (external read-only ref, classified index — see B2 classification)
VAULT_PATH = Path("D:/AI-哈比星球/知识库")
